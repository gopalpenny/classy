...
xnn = TransformerClassifier(64, dmodel = 36, nhead = 6, dhid = 100, nlayers = 3, data_dim = 6, nclasses = 4)
...
torch.save(xnn, os.path.join(sim_path, "s1_xnn_trained.pt"))    
...
# %%
plt.savefig(os.path.join(sim_path, "s1_training_loss.png"))
...
training_metrics.to_csv(os.path.join(sim_path,"s1_training_metrics.csv"))
